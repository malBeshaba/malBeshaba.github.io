...
![structure](https://refactoringguru.cn/images/patterns/diagrams/decorator/structure.png)

## 举例（伪代码）

![example](https://refactoringguru.cn/images/patterns/diagrams/decorator/example.png)
