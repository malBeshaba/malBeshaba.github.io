...
![structure](https://refactoringguru.cn/images/patterns/diagrams/facade/structure.png)

## 伪代码

在本例中， **外观**模式简化了客户端与复杂视频转换框架之间的交互。

![example](https://refactoringguru.cn/images/patterns/diagrams/facade/example.png)
